...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, opt, scaling_modifier = 1.0, override_color = None):
    ...
    import pdb
    #pdb.set_trace()
    # print("第二跳 这是GaussianRasterizer定义的位置")
    ...
    #        pdb.set_trace()
    #        print("if pipe.convert_SHs_python")
    ...
    #    else:
    #        pdb.set_trace()
    #        print("not pipe.convert_SHs_python")
    #        shs = pc.get_features
    #else:
    #    pdb.set_trace()
    ...
    import pdb
    #pdb.set_trace()
    # print("第二跳，这是GaussianRasterizer forward函数接受输入的位置")
    ...
    # import pdb
    # pdb.set_trace()
    # print("debug RuntimeError: CUDA error: an illegal memory access was encountered")
