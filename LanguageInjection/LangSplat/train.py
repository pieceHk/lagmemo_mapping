...
def training(
    ...
    print(type(scene.train_cameras[1.0]))
    print(scene.train_cameras[1.0])
    for it in scene.train_cameras[1.0]:
        print(type(it))
        print(it.image_name, it.R, it.T)
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        # print(viewpoint_cam.image_name, viewpoint_cam.R, viewpoint_cam.T)
        # pdb.set_trace()
        ...
        if (iteration - 1) == debug_from:
            pipe.debug = True
        # pdb.set_trace()
        # print("看来这才是langsplat渲染某视角的第一个位置")
        ...
        if opt.include_feature:
            ...
            # print(language_feature_mask.shape)
            # print(image)

            # print(language_feature.device)
            # print(gt_language_feature.device)
            ...
            # print(language_feature.requires_grad)
            # print(gt_language_feature.requires_grad)
            # print(language_feature_mask.requires_grad)
            # print(image.requires_grad)

            # print(language_feature.dtype)
            # print(gt_language_feature.dtype)
            # print(language_feature_mask.dtype)
            # print(image.dtype)

            # print(torch.isnan(language_feature).any())  # 检查是否有NaN值
            # print(torch.isinf(language_feature).any())  # 检查是否有Inf值

            # print(torch.isnan(gt_language_feature).any())  # 检查是否有NaN值
            # print(torch.isinf(gt_language_feature).any())

            # print(torch.isnan(language_feature_mask).any())  # 检查是否有NaN值
            # print(torch.isinf(language_feature_mask).any())

            # print(torch.isnan(image).any())  # 检查是否有NaN值
            # print(torch.isinf(image).any())

            # diff = language_feature - gt_language_feature
            # print("Difference:")
            # print(diff)
            ...
            # print(torch.isnan(Ll1).any())  # 检查是否有NaN值
            # print(torch.isinf(Ll1).any())
