...
from scene.colmap_loader import read_extrinsics_text, read_intrinsics_text, qvec2rotmat, \
    read_extrinsics_binary, read_intrinsics_binary, read_points3D_binary, read_points3D_text, my_extrinsics_init
...
def readColmapSceneInfo(path, images, eval, llffhold=8):
    # sfs: only needed w2c and rotation..
    cameras_extrinsic_path = os.path.join(path, "extrinsic/w2c.npz")
    cameras_intrinsic_file = os.path.join(path, "sparse/0", "cameras.txt")
    cam_extrinsics = my_extrinsics_init(cameras_extrinsic_path)
