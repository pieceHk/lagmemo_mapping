...
class GaussianModel:
    ...
    def restore(self, model_args, training_args):
        ...
        self.training_setup(training_args, only_ins_feat=True)
        ...
        if self._features_rest == None:
            ...
            self._features_rest = empty_tensor
    ...
    def training_setup(self, training_args, only_ins_feat=False):
        ...
        if only_ins_feat:
            l = [
                {'params': [self._ins_feat], 'lr': training_args.ins_feat_lr, "name": "ins_feat"}
            ]
            self._xyz.requires_grad_(False)
            self._features_dc.requires_grad_(False)
            # zht incase of 'NoneType' object has no attribute 'requires_grad_'
