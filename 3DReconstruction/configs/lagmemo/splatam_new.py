...
config = dict(
    workdir=f"/home/htz/works/3DGS/0301data/splatam_experiment/tee_f1",
    run_name=run_name,
    seed=seed,
    ...
    data=dict(
        basedir="/home/htz/works/3DGS/0301data/ori_dataset/tee_f1", #"/home/sfs/0504data/result",#
        gradslam_data_cfg="./configs/data/lagmemo640480.yaml",
        sequence=scene_name,
