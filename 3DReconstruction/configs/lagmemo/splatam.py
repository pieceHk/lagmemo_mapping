...
config = dict(
    workdir=f"./experiments/lagmemo_splatam/10/{group_name}",
    run_name=run_name,
    seed=seed,
    ...
    wandb=dict(
        entity="965371392-pku",
        project="SplaTAM-lagmemo",
        group=group_name,
        name=run_name,
        save_qual=False,
        eval_save_qual=True,
    ...
    data=dict(
        basedir="/home/sfs/SplaTAM/data/lagmemo",
        gradslam_data_cfg="./configs/data/lagmemo.yaml",
        sequence=scene_name,
        desired_image_height_init=360,
